...
| **Sprint 2**       | **Authentication & User Management** |  _PLANNED ⏳_   | JWT authentication, bcrypt passwords, refresh token rotation, user profiles, RBAC.                                                                  |
| **Sprint 3**       | **Incident & Sighting Reports**      |  _PLANNED ⏳_   | Generic incident CRUD, category tagging, image upload pipeline, status transitions.                                                                 |
